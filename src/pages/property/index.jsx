  ...
  return (
    <div className="container mx-auto border-l flex">
      <div className="w-[440px]">
        ...
        <div className="shadow-[0_5px_2px_0_rgba(0,0,0,0.25)] items-center justify-center rounded-md flex w-fit cursor-pointer ms-2 mt-5">
          <div
        ...
        <div className="flex">
          <div className="mt-8 w-[160px] border-r border-t">
                ...
                <div className="flex items-center gap-4">
                  <div>
                    <select
                      ...
                      className="py-2 outline-none border px-2 rounded-md "
                    >
                  ...
                  <div>
                    <select
                      ...
                      className="py-2 outline-none border px-2 rounded-full"
                    >
                      <option value="100000">100000</option>
                      <option value="200000">200000</option>
                      <option value="1200000">1200000</option>
            ...
            {activeModal === "Construction Status" && (
              <div className="p-3 border flex flex-col gap-6">
                ...
                <input
                  ...
                  name="selectAll"
                  checked={selectAll}
                  onChange={(event) => handleSelectAllChange(event, "status")}
                  className="appearance-none"
                />
                <label
                  htmlFor="selectAll"
                ...
                <div className="flex items-center gap-2">
                  ...
                  <div>
                    <select
                      ...
                      value={areaTo}
                      onChange={handleToChange}
                      className="py-2 outline-none border-black border px-2 rounded-full"
                    >
