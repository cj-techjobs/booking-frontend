  ...
  return (
    <Modal isVisible={context?.youraddresses} onClose={() => context?.setYouraddresses(false)}>
      <div className="">
        ...
        <div>
          <Image src={imageas} className="" alt="" />
        </div>
        <div className="p-5 ">
          ...
          <div className="flex gap-2 flex-col mt-3">
           ...
           <Image src={Vector} className="mb-[5px]" width={7} height={7} />
            <Image src={Vector} className="mb-[5px]" width={7} height={7} />
            <Image src={Vector} className="mb-[9px]" width={7} height={7} />

            <Image src={Vector} className="mb-[5px]" width={7} height={7} />
            <Image src={Vector} className="mb-[5px]" width={7} height={7} />
            <Image src={Vector} className="" width={7} height={7} />

           </div>

           <div className="flex items-center mb-[35px] gap-[0.5rem]">
            <Image src={Deliveryfast } width={20} height={20} />
              <div>
