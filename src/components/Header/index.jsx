...
const Header = () => {
  ...
  return (
    ...
    <header className="bg-white sticky top-0 z-20 shadow-md">
      <div className="container mx-auto px-4 lg:px-8 flex flex-col lg:flex-row items-center justify-between">
        <div className="hidden justify-center flex-row lg:flex items-center lg:gap-8 w-full lg:w-auto mb-4 lg:mb-0">
          <Link href="/" className="flex-shrink-0">
        ...
        <div className="relative lg:flex hidden w-full lg:w-1/2 mb-4 lg:mb-0">
          <input
            type="search"
            className="rounded-lg border bg-white w-full drop-shadow-md py-2 px-10 outline-none"
            placeholder="Search"
      ...
      <div
        className={`lg:hidden fixed top-0 right-0 w-1/2 h-screen bg-white shadow-md z-30 transition-transform duration-300 ${
          headerOpen ? "transform translate-x-0" : "transform translate-x-full"
        }`}
      >
        <div className="p-4">
          <button
        ...
        <div className="flex flex-col items-center">
          <div className="flex justify-center flex-col items-center lg:gap-8 w-full lg:w-auto mb-4 lg:mb-0">
            <Link href="/" className="flex-shrink-0">
              <Image src="/images/logo.svg" alt="logo" width={80} height={10} />
            </Link>
            <select
