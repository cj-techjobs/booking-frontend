  ...
  return (
    <div className="p-4">
      <div className="text-[48px] text-center">
        Post an <span className="text-red-500">ad</span>
      </div>
      {/* <div className="flex justify-center mt-2 mb-4">
        <div className="shadow-[0_5px_2px_0_rgba(0,0,0,0.25)] items-center justify-center rounded-md flex w-fit">
        <div className={`px-6 py-1 rounded-md ${isActive === 'Sell' ? 'bg-red-500 text-white' : 'bg-[#FAFAFA] rounded-l-md'}`} onClick={() => setIsActive('Sell')}>Sell</div>
        <div className={`px-6 py-1 rounded-md ${isActive === 'Rent' ? 'bg-red-500 text-white' : 'bg-[#FAFAFA] rounded-r-md'}`} onClick={() => setIsActive('Rent')} >Rent</div>
        </div>
      </div> */}
      <div>
        <form>
