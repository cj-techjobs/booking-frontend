  ...
  return (
    <div className="p-4">
      <div className="text-[48px] text-center">
       {isSell ? "Sell" : "Rent"} an <span className="text-red-500">item</span>
      </div>
      <div className="flex justify-center mt-2 mb-4">
        <div className="shadow-[0_5px_2px_0_rgba(0,0,0,0.25)] items-center justify-center rounded-md flex w-fit">
          <div
            ...
            onClick={() => {setIsActive("Sell");setIsSell(true);setIsRent(false)}}
          >
            Sell
          </div>
          <div
            ...
            onClick={() => {setIsActive("Rent");setIsSell(false);setIsRent(true)}}
          >
            Rent
          </div>
        </div>
      ...
      <div>
        ...
        {isRent && (
          ...
          <div className="flex gap-5 flex-col">
            ...
            <div>
              <label className="text-xl">Rate/per month</label>
              <input
                type="text"
                className="outline-none placeholder:text-sm appearance-none border-b-2 border-black w-full"
                placeholder="Text here*"
            ...
            <div>
              <label className="text-xl">Purchase Rate {"("}for security money{")"}</label>
              <input
                type="text"
                className="outline-none placeholder:text-sm appearance-none border-b-2 border-black w-full"
                placeholder="Security money will be half of purchase rate*"
              />
            </div>
            <div className="flex flex-col justify-center items-center ">
              <div className="cursor-pointer">
